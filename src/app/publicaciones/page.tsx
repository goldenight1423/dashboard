  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="flex flex-wrap gap-3 items-end">
        <div>
          <label className="block text-xs text-gray-500 mb-1">Postura</label>
          <select
            value={postura}
        ...
        <div>
          <label className="block text-xs text-gray-500 mb-1">Imaginario</label>
          <select
            value={imaginario}
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-800">
              {loading ? (
                <tr><td colSpan={9} className="text-center py-8 text-gray-600">Cargando...</td></tr>
              ) : pubs.map(pub => (
          ...
          <div className="px-4 py-3 border-t border-gray-800 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3 py-1 text-xs bg-gray-800 text-gray-400 rounded-lg disabled:opacity-40 hover:bg-gray-700"
              >
                ← Anterior
              </button>
